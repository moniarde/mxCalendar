...
$_lang['mxcalendars.desc'] = 'Verwalten sie ihre Kalendereinträge hier.';
...
$_lang['mxcalendars.grid_col_formchunk'] = 'Formular';
$_lang['mxcalendars.txt_search_default'] = 'Suche ...';
$_lang['mxcalendars.btn_display_past_events'] = 'vergangene Ereignisse anzeigen';
$_lang['mxcalendars.btn_create'] = 'Neue Kalenderinstanz erzeugen';
$_lang['mxcalendars.label_product'] = 'Produkt';
$_lang['mxcalendars.label_industry'] = 'Industrie';
$_lang['mxcalendars.label_select_context'] = 'Wählen Sie eine Seite (Kontext) oder für alle freilassen';
...
$_lang['mxcalendars.label_repeaton']='findet statt an';
$_lang['mxcalendars.label_repeat_frequency'] = 'wiederholt sich jeden';
$_lang['mxcalendars.label_repeat_last_occurance'] = 'letzter Termin';
$_lang['mxcalendars.label_description'] = 'Beschreibung';
$_lang['mxcalendars.label_location'] = 'Ort';
$_lang['mxcalendars.label_name'] = 'Name';
$_lang['mxcalendars.label_address'] = 'Adresse';
$_lang['mxcalendars.label_display_map'] = 'Karte anzeigen';
$_lang['mxcalendars.label_link'] = 'Link';
$_lang['mxcalendars.label_link_rel'] = 'Link Rel';
$_lang['mxcalendars.label_link_target'] = 'Link Ziel';
$_lang['mxcalendars.label_cancel'] = 'abbrechen';
$_lang['mxcalendars.label_save'] = 'speichern';
$_lang['mxcalendars.label_sunday'] = 'Sonntag';
$_lang['mxcalendars.label_monday'] = 'Montag';
$_lang['mxcalendars.label_tuesday'] = 'Dienstag';
$_lang['mxcalendars.label_wednesday'] = 'Mittwoch';
$_lang['mxcalendars.label_thursday'] = 'Donnerstag';
$_lang['mxcalendars.label_friday'] = 'Freitag';
$_lang['mxcalendars.label_saturday'] = 'Samstag';
$_lang['mxcalendars.label_daily'] = 'täglich';
$_lang['mxcalendars.label_weekly'] = 'wöchentlich';
$_lang['mxcalendars.label_monthly'] = 'monatlich';
$_lang['mxcalendars.label_yearly'] = 'jährlich';
$_lang['mxcalendars.label_forms'] = 'Formular';
...
$_lang['mxcalendars.err_event_req_endtime'] = 'Endzeit wird benötigt';
$_lang['mxcalendars.label_select_context_err'] = 'Alle Seiten';
$_lang['mxcalendars.err_event_req_repeattype'] = 'Art der Wiederholung wird benötigt';
$_lang['mxcalendars.err_event_req_repeatfrequency'] = 'wiederholen alle, Frequenz, wird benötigt für wiederkehrende Ereignisse';
...
$_lang['mxcalendars.endtime_col_label'] = 'Endzeit';
$_lang['mxcalendars.repeating_col_label'] = 'wiederkehrend';
$_lang['mxcalendars.repeating_last_occ_col_label'] = 'letzte Wiederholung';

$_lang['mxcalendars.label_startdate'] = 'Start Datum/Zeit';
$_lang['mxcalendars.label_starttime'] = 'Startzeit';
...
$_lang['mxcalendars.tip_repeaton'] = 'wiederholen jede ___ (Tage|Wochen|Monate|Jahre).<br /><br />bestimmen Sie die Wiederholungsfrequenz: (täglich, wöchentlich, monatlich, jährlich) oben';
//$_lang['mxcalendars.'] = '';
...
$_lang['mxcalendars.category_backgroundcss_col_label'] = 'Hintergrundfarbe';
...
$_lang['mxcalendars.set_event_desc_type'] = 'Beschreibung Feld-Typ';
$_lang['mxcalendars.set_mgr_dateformat'] = 'Datum Format';
...
$_lang['mxcalendars.calendar_context_menu_update'] = 'aktualisieren';
$_lang['mxcalendars.calendar_context_menu_remove'] = 'entfernen';
